...
int main () {
	...
	A2.write_to_device(); // copy data from host memory to device memory
	B2.write_to_device();
	mul_kernel.run(); // run add_kernel on the device
	C2.read_from_device(); // copy data from device memory to host memory
